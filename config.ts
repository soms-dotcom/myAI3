...
export const AI_NAME = "Health Buddy";
export const OWNER_NAME = "Specialized Healthcare Agent";

export const WELCOME_MESSAGE = `Hey! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}.`
